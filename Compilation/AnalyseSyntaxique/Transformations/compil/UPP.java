...
class UPPNot extends UPPUnOp {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, PRegister reg, RTLInst succ) {
        PRegister eR = e.getPRegister(locals) ;
        return new RTLXOri(eR,reg,succ); 
...
class UPPCond extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
        ...
        return new RTLGtz(regCond,i1.toRTL(locals, globals, succ),i2.toRTL(locals, globals, succ));
    }//toRTL
...
class UPPSeq extends UPPInst {
    ...
    RTLInst toRTL (ArrayList<Pair<String,PRegister>> locals,
                   ArrayList<String> globals, RTLInst succ) {
        //To do
        i1.toRTL(locals, globals, i2.toRTL(locals, globals, new RTLEnd()));
        return new RTLEnd();
    }//toRTL        
