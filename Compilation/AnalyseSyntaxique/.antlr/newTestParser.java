...
public class newTestParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, Boolean=3, Number=4;
	public static final int
		RULE_typeExpr = 0;
	...
	public final TypeExprContext typeExpr() throws RecognitionException {
		...
		enterRule(_localctx, 0, RULE_typeExpr);
		try {
			setState(6);
			...
			case T__0:
				...
				match(T__0);
				setState(3);
				((TypeExprContext)_localctx).x = match(Number);
	...
	public static final String _serializedATN =
		...
		"\7\6\2\2\6\t\b\2\1\2\7\t\7\4\2\2\b\4\3\2\2\2\b\7\3\2\2\2\t\3\3\2\2\2\3"+
		"\b";
