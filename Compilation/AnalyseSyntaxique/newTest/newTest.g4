...
| x = FunFormat { $value = new User($x.text); }
;
...
e1 = FunFormat '(' e2 = pairArrayExpr ')' ':' e5 = typeExpr e3 = pairArrayExpr e4= insExpr  
{ $value = new PPFun($e1.text, $e2.value ,$e3.value , $e4.value, $e5.value ); }

e1 = FunFormat '(' e2 = pairArrayExpr ')' e3 = pairArrayExpr e4= insExpr  
