...
(setq liste '((ADD (:CONST 56) :R0) (MULT (:CONST 2) :R0) (LABEL mlabel) (MOVE :R0 :R1)))


(format T "resultat : 
 ~d
"  (car (car '((ADD '(:CONST 2) :R0) (MULT 5 6) (LABEL mlabel) (MOVE :RO :R1)))))
...
(vm_get_hashTab_etq_resolu vm 'mlabel)


(format T "
Valeur du label: ~d
"  (aref (getProp vm :memoire) (vm_get_hashTab_etq_resolu vm 'mlabel))
