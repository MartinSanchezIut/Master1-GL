 ...
 * 
 */
@WebServiceClient(name = "HotelService", targetNamespace = "http://hotelservice/", wsdlLocation = "http://localhost:8080/Les3Chenes?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICE_QNAME = new QName("http://hotelservice/", "HotelService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/Les3Chenes?wsdl");
    ...
    public IHotelService getHotelPort() {
        return super.getPort(new QName("http://hotelservice/", "HotelPort"), IHotelService.class);
    }
    ...
    public IHotelService getHotelPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hotelservice/", "HotelPort"), IHotelService.class, features);
    }
