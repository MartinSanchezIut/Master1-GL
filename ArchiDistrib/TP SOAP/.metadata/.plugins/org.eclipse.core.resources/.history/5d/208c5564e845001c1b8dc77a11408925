 ...
 * generated in the hai704i.tp2.exo2.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _DivideResponse_QNAME = new QName("http://server.exo2.tp2.hai704i/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://server.exo2.tp2.hai704i/", "divide");
    private final static QName _Multiply_QNAME = new QName("http://server.exo2.tp2.hai704i/", "multiply");
    private final static QName _Add_QNAME = new QName("http://server.exo2.tp2.hai704i/", "add");
    private final static QName _Subtract_QNAME = new QName("http://server.exo2.tp2.hai704i/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://server.exo2.tp2.hai704i/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://server.exo2.tp2.hai704i/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://server.exo2.tp2.hai704i/", "multiplyResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: hai704i.tp2.exo2.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.exo2.tp2.hai704i/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.exo2.tp2.hai704i/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.exo2.tp2.hai704i/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.exo2.tp2.hai704i/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.exo2.tp2.hai704i/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.exo2.tp2.hai704i/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.exo2.tp2.hai704i/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.exo2.tp2.hai704i/", name = "multiplyResponse")
