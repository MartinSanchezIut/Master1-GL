 ...
 * generated in the ex2.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _Subtract_QNAME = new QName("http://server.ex2/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://server.ex2/", "subtractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://server.ex2/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://server.ex2/", "multiplyResponse");
    private final static QName _Add_QNAME = new QName("http://server.ex2/", "add");
    private final static QName _Multiply_QNAME = new QName("http://server.ex2/", "multiply");
    private final static QName _DivideResponse_QNAME = new QName("http://server.ex2/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://server.ex2/", "divide");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ex2.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex2/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex2/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex2/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex2/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex2/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex2/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex2/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ex2/", name = "divide")
