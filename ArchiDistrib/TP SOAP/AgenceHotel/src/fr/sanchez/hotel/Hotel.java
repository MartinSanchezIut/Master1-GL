...
public class Hotel {
	...
	public String reserver(Chambre chambre, Client client, String debut, String fin) {
	...
	public ArrayList<Chambre> rechercher(String nom, String mdp, String date, String date1, int prixMin, int prixMax, int lits) {
		Integer reduction = 0;
		for (Partenaire p : partenaires) {
			if (p.getNomAgence().equalsIgnoreCase(nom) && p.getMotdepasse().equals(mdp)) {
