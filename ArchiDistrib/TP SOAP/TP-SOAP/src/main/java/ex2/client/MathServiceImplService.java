 ...
 * 
 */
@WebServiceClient(name = "MathServiceImplService", targetNamespace = "http://server.ex2/", wsdlLocation = "http://localhost:8080/mathservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MATHSERVICEIMPLSERVICE_QNAME = new QName("http://server.ex2/", "MathServiceImplService");
    ...
    public MathService getMathServiceImplPort() {
        return super.getPort(new QName("http://server.ex2/", "MathServiceImplPort"), MathService.class);
    }
    ...
    public MathService getMathServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.ex2/", "MathServiceImplPort"), MathService.class, features);
    }
